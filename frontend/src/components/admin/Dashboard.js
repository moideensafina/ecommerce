    ...
    return(
        <div className="row">
            ...
            <div className="col-12 col-md-10 dashboard">
                <h1 className="my-4 ms-3">Dashboard</h1>
                <div className="row pr-4 m-5">
                ...
                <div className="row pr-4 m-5">
                    <div className="col-xl-3 col-sm-6 mb-3">
                        <div className="card text-white bg-success o-hidden h-100">
                            ...
                            <Link className="card-footer btn text-white clearfix small z-1" to="/admin/products">
                                <span className="float-left">View Details</span>
                                <span className="float-right">
                                    <i className="ps-2 fa fa-angle-right"></i>
                                </span>
                            </Link>
                        </div>
                    </div>
                    ...
                    <div className="col-xl-3 col-sm-6 mb-3">
                        <div className="card text-white bg-danger o-hidden h-100">
                            ...
                            <Link className="card-footer btn text-white clearfix small z-1" to="/admin/orders">
                                <span className="float-left">View Details</span>
                                <span className="float-right">
                                    <i className="ps-2 fa fa-angle-right"></i>
                                </span>
                    ...
                    <div className="col-xl-3 col-sm-6 mb-3">
                        <div className="card text-white bg-info o-hidden h-100">
                            ...
                            <Link className="card-footer btn text-white clearfix small z-1" to="/admin/users">
                                <span className="float-left">View Details</span>
                                <span className="float-right">
                                    <i className="ps-2 fa fa-angle-right"></i>
                                </span>
