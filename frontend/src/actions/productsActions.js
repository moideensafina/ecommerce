...
import { adminProductsRequest, adminProductsSuccess, productsFail, productsRequest, productsSuccess } from '../slices/productsSlice';
...
export const getProducts=(keyword,priceChanged,category,rating,currentPage) =>  async(dispatch)=>{
...
export const createReview =reviewData=> async(dispatch)=>{
    ...
    export const getAdminProducts= async(dispatch)=>{
        ...
        try {
            ...
            //handle error
            dispatch(adminProductsSuccess(error.response.data.message))
        }
